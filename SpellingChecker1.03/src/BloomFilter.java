/**
 * Bloom Filter Algorithm implementation for Spelling Checking correcting errors in spelling words 
 * using a hashing method it uses UTF-8 unicode and MD5 encryption 
 */
...
public class BloomFilter<E> implements Serializable 
{
    ...
    */
    ...
    {
        BloomFilter <Integer> filter = new BloomFilter <Integer> (0.323,98000);
        filter.add(23);
